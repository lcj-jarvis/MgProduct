...
public class InOutStoreRecordEntity {
    public static final class Info {
        ...
        public static final String RL_ORDER_CODE = "rlOrderCode";                   // varchar(32) 业务订单code  TODO
        public static final String RL_REFUND_ID = "rlRefundId";                     // varchar(32) 业务退款编号  TODO
