            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        rt = productSpecSkuCodeProc.refresh(aid, unionPriId, pdId, newSkuCodeSkuIdMap, needDelSkuCodeSkuIdList, skuCodeSortList, changeSkuCodeSkuIdSet);
                        if(rt != Errno.OK){
                            return rt;
                        }
                    }finally {
