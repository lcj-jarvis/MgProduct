...
public class ProductGroupBakDaoCtrl extends DaoCtrl {
    private String tableName;

    public ProductGroupBakDaoCtrl(int flow, int aid) {
        super(flow, aid);
    ...
    public static ProductGroupBakDaoCtrl getInstance(int flow, int aid) {
        if(m_daoPool == null) {
            Log.logErr("m_daoPool is not init;");
            return null;
        }
        return new ProductGroupBakDaoCtrl(flow, aid);
    }
