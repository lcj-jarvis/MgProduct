...
import fai.MgProductSpecSvr.domain.comm.SagaRollback;
import fai.MgProductSpecSvr.domain.repository.CacheCtrl;
import fai.MgProductSpecSvr.domain.serviceProc.SpecSagaProc;
 ...
 * @date 2021/9/6 9:27
 */
public class SpecParentService extends ServicePub {
    ...
    public int doRollback(int flow, int aid, String xid, long branchId, SagaRollback sagaRollback) {
        ...
        try {
            ...
            try {
                ...
                SpecSagaProc sagaProc = new SpecSagaProc(flow, aid, tc);
